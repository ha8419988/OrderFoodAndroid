package com.example.orderfoodandroid.database;
...
//tạo bảng Orderdetail sau đó thêm các giá trị đc get từ local storage(foodname,price..)
public class Database extends SQLiteAssetHelper {
    ...
    public void addToCart(Order order) {
        ...
        String query = String.format("INSERT OR REPLACE INTO OrderDetail(UserPhone,ProductId,ProductName,Quantity,Price,Discount,Image) VALUES('%s','%s','%s','%s','%s','%s','%s');",
                order.getUserPhone(),
                order.getProductId(),//it will be null
    ...
    //viết Function cho Favorite(thêm/xóa)
